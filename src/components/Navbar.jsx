    ...
    return (
        <nav className="w-full h-12 hidden bg-primary lg:flex p-4 justify-between items-center fixed z-50 dark:bg-gray-800 dark rounded-b-md">
            ...
            <div className="flex space-x-8">
                <a className="font-bold text-md text-second hover:text-black" href="#home">Home</a>
                <a className="font-bold text-md text-second hover:text-black" href="#popular">Lista de productos</a>
